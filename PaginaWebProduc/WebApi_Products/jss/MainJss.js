...
function gridBuilder(data) {
    ...
    var header = $('<tr></tr>');
    header.append('<td class="col-md2">Id</td>');
    header.append('<td class="col-md4">Nombre</td>');
    header.append('<td class="col-md4">Descripcion</td>');
    header.append('<td class="col-md1">Precio</td>');
    header.append('<td class="col-md1">Stock</td>');

    tbl.append(header);

    for (d in data) {
        var row = $('<tr class="jqClickeable" class="d-flex"></tr>');
        row.append('<td class="col col-lg-2">' + data[d].Id + '</td>');
        row.append('<td class="col-md4 col-lg-4">' + data[d].Nombre + '</td>');
        row.append('<td class="col-md4 col-lg-4">'+ data[d].Descripcion + '</td>');
        row.append('<td class="col-md1 col-lg-1">' + data[d].Precio + '</td>');
        row.append('<td class="col-md1 col-lg-1">' + data[d].Stock + '</td>');
